...
module.exports.views = {
    ...
    *                                                                           *
    * ejs, ejs, ejs, mustache underscore, hogan, haml, haml-coffee,     *
    ...
    * your server-side views. If you're using ejs or ejs, you can take         *
    ...
    *                                                                           *
    * If you're using the default `ejs` or `ejs` Sails supports the use  *
    ...
    * for your server-side views. If you're using ejs, you can take      *
